...
App.i18n = (function () {
  ...
  const DICTS = {
    en: {
      ...
      btnSeedRandom: "Add 50 random test locations",
      btnReject: "Reject",
      btnEdit: "Edit",
      btnConfirm: "Confirm",
      ...
      printRunUnconfirmed: "Printing unconfirmed: this Depósito Legal comes from the catalogue record the barcode matched, not from the book. Publishers reuse a cover ISBN across reprints — photograph the ficha técnica to pin the exact printing.",
      ...
      logNoMatches: "No encounters match this search or filter.",
      logSearchPlaceholder: "Search title, author, note…",
      ctxNone: "no context",
      "logCountAll_one": "{n} encounter",
      "logCountAll_other": "{n} encounters",
      logCountFiltered: "{n} of {total} shown",
      btnLogSelect: "Select",
      btnLogSelectDone: "Done",
      btnLogSelectAll: "Select all",
      btnLogDeleteOne: "Delete this encounter",
      btnBack: "Back",
      btnDeleteEncounter: "Delete encounter",
      fieldLocation: "Location",
      fieldLoggedAt: "Logged",
      detailLocationNote: "Location note",
      detailNote: "Personal note",
      locationSourceGps: "GPS",
      locationSourceManual: "set manually",
      btnLogDeleteSelected: "Delete ({n})",
      btnUndo: "Undo",
      "toastDeleted_one": "{n} encounter deleted.",
      "toastDeleted_other": "{n} encounters deleted.",
      "toastRestored_one": "{n} encounter restored.",
      "toastRestored_other": "{n} encounters restored.",
      ...
      statusEncounterPrompt: "Photograph the book you found.",
      statusIdentifyPrompt: "Point at the barcode, or photograph the copyright page.",
      camModeIdentify: "Identify",
      camModePhoto: "Photo",
      camScanLooking: "Looking for a barcode…",
      btnCamSkip: "Skip",
      btnCamSkipPhoto: "No photo",
      btnShutterPage: "Photograph the copyright page",
      btnShutterPhoto: "Take photo",
      ...
      toastIdentified: "Got it! Now photograph the book.",
      toastEncounterSaved: "Encounter saved.",
      toastSeeded: "Added {n} random test locations.",
    ...
    pt: {
      ...
      btnSeedRandom: "Adicionar 50 localizações de teste aleatórias",
      btnReject: "Rejeitar",
      btnEdit: "Editar",
      ...
      printRunUnconfirmed: "Tiragem não confirmada: este Depósito Legal vem do registo do catálogo correspondente ao código de barras, não do livro. As editoras reutilizam o ISBN da capa em reimpressões — fotografe a ficha técnica para fixar a tiragem exata.",
      ...
      logNoMatches: "Nenhum encontro corresponde a esta pesquisa ou filtro.",
      logSearchPlaceholder: "Pesquisar título, autor, nota…",
      ctxNone: "sem contexto",
      "logCountAll_one": "{n} encontro",
      "logCountAll_other": "{n} encontros",
      logCountFiltered: "{n} de {total} mostrados",
      btnLogSelect: "Selecionar",
      btnLogSelectDone: "Concluir",
      btnLogSelectAll: "Selecionar tudo",
      btnLogDeleteOne: "Eliminar este encontro",
      btnBack: "Voltar",
      btnDeleteEncounter: "Eliminar encontro",
      fieldLocation: "Localização",
      fieldLoggedAt: "Registado",
      detailLocationNote: "Nota de local",
      detailNote: "Nota pessoal",
      locationSourceGps: "GPS",
      locationSourceManual: "definida manualmente",
      btnLogDeleteSelected: "Eliminar ({n})",
      btnUndo: "Anular",
      "toastDeleted_one": "{n} encontro eliminado.",
      "toastDeleted_other": "{n} encontros eliminados.",
      "toastRestored_one": "{n} encontro restaurado.",
      "toastRestored_other": "{n} encontros restaurados.",
      ...
      statusEncounterPrompt: "Fotografe o livro que encontrou.",
      statusIdentifyPrompt: "Aponte ao código de barras, ou fotografe a ficha técnica.",
      camModeIdentify: "Identificar",
      camModePhoto: "Foto",
      camScanLooking: "À procura de um código de barras…",
      btnCamSkip: "Saltar",
      btnCamSkipPhoto: "Sem foto",
      btnShutterPage: "Fotografar a ficha técnica",
      btnShutterPhoto: "Tirar foto",
      ...
      toastIdentified: "Encontrado! Agora fotografe o livro.",
      toastEncounterSaved: "Encontro guardado.",
      toastSeeded: "Foram adicionadas {n} localizações de teste aleatórias.",
